...
EFFORT_REQD = [round(np.random.uniform(4,5) * 60) for i in range(NUMBER_OF_STUDENTS)] 
...
def main_loop(env):
    ...
    print("Each student requires {} minutes of effort to complete the assignment".format(EFFORT_REQD))
