...
seats = simpy.Resource(env, capacity=TOTAL_NUM_SEATS) # create a resource to model seats
env.process(customer_arrival(env,seats)) # create a process to model customer arrivals.
